    ...
    <ScrollView style={styles.container}>
      <View style={styles.card}>
        ...
        <View style={styles.inputContainer}>
          <Icon name="user" type="font-awesome" color="#161616" size={20} />
          <TextInput
            style={styles.input}
        ...
        {/* Email Input */}
        <View style={styles.inputContainer}>
          <Icon name="envelope" type="font-awesome" color="#161616" size={20} />
          <TextInput
            style={styles.input}
        ...
        <View style={styles.inputContainer}>
          <Icon name="lock" type="font-awesome" color="#161616" size={20} />
          <TextInput
            style={styles.input}
        ...
        {/* New Password Input */}
        <View style={styles.inputContainer}>
          <Icon name="key" type="font-awesome" color="#161616" size={20} />
          <TextInput
            style={styles.input}
